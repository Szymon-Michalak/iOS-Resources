...
That’s where the `final` keyword comes in. The `final` keyword prevents a `class` from being subclassed / inherited from and indicates to other developers that this `clas` sisn’t designed to be subclassed.
